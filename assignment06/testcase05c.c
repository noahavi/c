...
int main(void)
{
	...
	source.name = "Low Key Covfefe";
	source.pancake_count = 3.52212;
	source.pancakes_per_minute = 0.12579;
	source.minutes_spent_munching = 28.00000;
